...
if __name__ == "__main__":
    ...
    ## SSF
    SSF_checkpoint_path='/home/media/CH/GFVC_SOftware/GFVC_Software-main-315_right/SSF-checkpoint.pth.tar'
    SSF_config_path='/home/media/CH/GFVC_SOftware/GFVC_Software-main-315_right/vox-256.yaml'
    SSF_Analysis_Model, SSF_Synthesis_Model, cross_scale_m_fusion, Depth_Net, videocompressor, generator_Refine = load_SSF_checkpoints(
        SSF_config_path, SSF_checkpoint_path, cpu=False)
    modeldir = 'SSF'
    ...
    for frame_idx in range(0, frames):            
        ...
        if frame_idx in [0]:      # I-frame                      
            ...
            with torch.no_grad(): 
                ...
                kp_reference = SSF_Analysis_Model(reference, reference_depth['disp', 0]) ################
            ...
            prediction = make_SSF_prediction(reference, kp_reference, kp_current, SSF_Synthesis_Model, M_i, generator_Refine) #######################
            gene_end = time.time()
