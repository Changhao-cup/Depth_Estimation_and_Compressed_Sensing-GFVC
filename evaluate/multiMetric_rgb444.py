...
if __name__ == "__main__":
    ...
    result_dir = '/home/media/CH/GFVC_SOftware/GFVC_Software-main-315_right/experiment/'+Model+'/Iframe_'+Iframe_format+'/evaluation/'
    ...
    for seq in seqlist:
        ...
        for qp in qplist:
            ...
            f_org=open('/home/media/CH/GFVC_SOftware/testing_sequence/'+opt.testingdata_name+'_'+str(seq)+'_'+str(width)+'x'+str(height)+'_25_8bit_444.rgb','rb')

            f_test=open('/home/media/CH/GFVC_SOftware/GFVC_Software-main-315_right/experiment/'+Model+'/Iframe_'+Iframe_format+'/dec/'+opt.testingdata_name+'_'+str(seq)+'_256x256_25_8bit_444_QP'+str(qp)+'.rgb','rb')
