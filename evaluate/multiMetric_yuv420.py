...
if __name__ == "__main__":
 ...
 # 'CFVQA' OR 'VOXCELEB'
    ...
    result_dir = '/home/media/CH/GFVC_SOftware/GFVC_Software-main-315_right/experiment/'+Model+'/Iframe_'+Iframe_format+'/evaluation-YUV420/'
    ...
    for seq in seqlist:
        ...
        for qp in qplist:
            ...
            original_video = '/home/media/CH/GFVC_SOftware/testing_sequence/OriYuv/'+opt.testingdata_name+'_'+str(seq)+'_'+str(width)+'x'+str(height)+'_25_8bit_420.yuv'
                        
            encoded_video = '/home/media/CH/GFVC_SOftware/GFVC_Software-main-315_right/experiment/'+Model+'/Iframe_'+Iframe_format+'/dec_yuv420/'+opt.testingdata_name+'_'+str(seq)+'_256x256_25_8bit_420_QP'+str(qp)+'.yuv'
